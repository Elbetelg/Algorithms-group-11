...
* **Partition.java**: Stores partition boundaries and value ranges used in the hybrid algorithm.
...
* * **Hardware Consideration:** Results may vary depending on CPU architecture (e.g., AMD vs. Intel) and system environment, which can affect cache behavior and performance outcomes.
